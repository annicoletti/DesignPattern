...
public class ReflectionService {
    ...
    public void printClassInfo(Class<?>... classes) {
    ...
    public void printConstructorData(Class<?> clazz) {
    ...
    public <T> T createInstanceWithArguments(Class<T> clazz, Object... args) {
    ...
    public void printDeclaredFieldsInfo(Class<?> clazz) {
    ...
    public Object parseArray(Class<?> arrayElementType, String value) {
    ...
    public <T> T createInstanceWithArgumentsV2(Class<T> clazz, Object... args) {
        ...
        try {
            ...
            if (declaredConstructors.length > 0) {
                // Se houver construtor instancia objeto
                ...
                Class<?> clazzType = Class.forName(clazz.getComponentType().getName());
                object = Array.newInstance(clazzType, args.length);

                // Preenche o array com os dados enviado pelo argumento 
                for (int i = 0; i < args.length; i++) {
                    Object obj = createInstanceWithArgumentsV2(clazzType, args[i]);
